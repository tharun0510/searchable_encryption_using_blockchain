                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="PrivateBlockChainViewFiles.jsp">Uploaded Files</a></li>
                            <li class="scroll-to-section"><a href="PrivateBlockChainDataUserList.jsp" >DataUsers</a></li>
                            <li class="scroll-to-section"><a href="AcceptRequest.jsp" >Accept Request</a></li>
...
service provider identifies matches by executin</p>
                            <a href="#" class="main-button">
                                Discover More
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            ...
                            <p>A blockchain is a distributed public database based
