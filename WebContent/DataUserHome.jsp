                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="UploadedFiles.jsp">Uploaded Files</a></li>
                            <li class="scroll-to-section"><a href="SendFileRequest.jsp" >Send Request</a></li>
                         	<li class="scroll-to-section"><a href="RequestSearchKey.jsp" >Download</a></li>
                    ...
                    <ul>
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                            ...
                            <div class="text">
                                ...
                                rel="nofollow" href="" target="_parent">contact</a> us for
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            ...
                            <div class="text">
                                ...
                                <p>You can <a rel="nofollow"
                                        href="">
                                        </a> from our website. Duis viverra, ipsum et scelerisque placerat, orci
