		...
		<div class="row">
			<div class="col-md-12">
				<div class="navbar-header animated fadeInUp">
					<a class="btn btn-danger mt-2" href="PrivateBlockChainHome.jsp">BACK</a>
					
					 <c:if test="${param.success==1}">
		<div class="alert alert-success alert-dismissible fade show"
			role="alert">
			<strong>Success!</strong>ACCEPTED<a
				href="Home.jsp"></a>
					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn btn-primary btn-sm" type="submit"
									href="AcceptRequestProcess.jsp?filename=<%=rs.getString("fileName") %>">Accept</a></td>
							</tr>
