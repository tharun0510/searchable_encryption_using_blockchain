					...
					<table id="myTable" class="table table-bordred table-striped">
						...
						<%
							...
							try {
								...
								PreparedStatement ps1 = con1.prepareStatement("SELECT * FROM `fileaccept` where filename='"+filename+"' and keywords='"+keyword+"'");
						...
						<tbody>
							...
							<tr>
								...
								<td><a class="btn btn-primary btn-sm" type="submit"  href="EncryptedFileForDownload.jsp?Filename=<%=rs.getString("filename")%> & keyword=<%=rs.getString("keywords")%> & secretKey=<%=rs.getString("SecretKey")%>">Download</a></td>
							</tr>
